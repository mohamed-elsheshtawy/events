                                ...
                                <form action="{{ route('services.store') }}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <textarea class="form-control" id="content_ar" name="content_ar" rows="3"@error('content_ar') is-invalid @enderror></textarea>
                                            @error('content_ar')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col">
                                            ...
                                            <textarea class="form-control" id="content_en" name="content_en" rows="3"@error('content_en') is-invalid @enderror></textarea>
                                            @error('content_en')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
