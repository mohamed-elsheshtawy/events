    ...
    <div id="layoutSidenav_content">
        ...
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4 wow fadeInLeft h-100" data-wow-duration="1s" data-wow-delay=".5s">{{ __('words.Clients') }}
                </h1>
                ...
                <div class="row">
                    ...
                    @endif
                    <div class="add_btn">
                        <a href="clients/create" class="btn btn-success px-5 wow fadeInLeft h-100" data-wow-duration="1s"
                        ...
                        <tbody>
                            @foreach ($clients as $index => $client)
                                <tr>
                                    <td>{{ ++$index }}</td>
                                    <td>
                                        <img class="img-radius" src="{{ asset('media/media/' . $client->media) }}"
                                    ...
                                    <td>
                                        <a class="btn btn-warning"
                                            href=" {{ route('clients.edit', $client->id) }}">{{ __('words.edit') }}
                                        </a>


                                        <a class="btn btn-danger" href="#" data-client_id="{{ $client->id }}"
