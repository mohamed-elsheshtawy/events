                            ...
                            <form action="{{ route('clients.update', $Clients->id) }} " method="post"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="{{ $Clients->title_ar }}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" id="desc_ar" name="desc_ar" rows="3"@error('desc_ar') is-invalid @enderror> {{ $Clients->desc_ar }}</textarea>
                                        @error('desc_ar')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" id="desc_en" name="desc_en" rows="3"@error('desc_en') is-invalid @enderror>{{ $Clients->desc_en }}</textarea>
                                        @error('desc_en')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
